...
const viewContentPopup = document.querySelector('.content-popup');
const btnContentTitle = document.querySelector('.content-popup__title');
...
function togglePopup() {
  viewContentPopup.classList.toggle('hide');
  btnPopup.classList.toggle('hide');
}
...
const pageToggle = btnPageToggle.addEventListener('click', function (e) {
  ...
  if (!dashboard) {
    ...
    sectionReview.classList.add('hide');
    ...
    sectionReview.classList.remove('hide');
...
const popupToggle = btnPopup.addEventListener('click', togglePopup);
const contentToggle = btnContentTitle.addEventListener('click', togglePopup);
